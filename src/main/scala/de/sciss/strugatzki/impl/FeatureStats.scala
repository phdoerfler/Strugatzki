...
import concurrent.{Promise, ExecutionContext, blocking}

private[strugatzki] final class FeatureStats(val config: IndexedSeq[ File ],
                                             protected val observer: FeatureStats.Observer,
                                             protected val promise: Promise[FeatureStats.PayLoad])
                                            (implicit protected val executionContext: ExecutionContext)
extends ProcessorImpl[FeatureStats.PayLoad, FeatureStats.Config] {

   import FeatureStats._


  protected val companion = FeatureStats
